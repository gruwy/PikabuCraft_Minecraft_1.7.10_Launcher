<?php
	...
	*/
	...
	$db_user			= 'gruwy_dle'; // Пользователь базы данных
	$db_pass			= 'kristi'; // Пароль базы данных
	$db_database		= 'gruwy_launcher'; //База данных
...
//========================= Настройки ЛК =======================//	
    ...
    $skinurl            = 'http://pikabucraft.online/pikabulauncher/'.$uploaddirs.'/'; //Ссылка на скины для клиентов 1.7.+
    $capeurl            = 'http://pikabucraft.online/pikabulauncher/'.$uploaddirp.'/'; //Ссылка на плащи для клиентов 1.7.+
