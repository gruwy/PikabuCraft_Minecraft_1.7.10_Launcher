...
public class ThemeUtils extends BaseUtils
{
	public static void updateStyle(Frame main) throws Exception
	{
		...
		buyBronze.apply(main.buyBronze);
		buySilver.apply(main.buySilver);
		buyGold.apply(main.buyGold);
		buyDiamond.apply(main.buyDiamond);
        buyGod.apply(main.buyGod);
        buyFly.apply(main.buyFly);
        buyPrefix.apply(main.buyPrefix);
        buyNickColor.apply(main.buyNickColor);
        buyAntiAFK.apply(main.buyAntiAFK);
