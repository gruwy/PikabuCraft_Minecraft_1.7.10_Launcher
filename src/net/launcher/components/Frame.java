...
public class Frame extends JFrame implements ActionListener, FocusListener
{
	...
	public Button buyBronze = new Button(Message.buyBronze);
	public Button buySilver = new Button(Message.buySilver);
	public Button buyGold = new Button(Message.buyGold);
	public Button buyDiamond = new Button(Message.buyDiamond);
	public Button buyGod = new Button(Message.buyGod);
	public Button buyFly = new Button(Message.buyFly);
	public Button buyPrefix = new Button(Message.buyPrefix);
	public Button buyNickColor = new Button(Message.buyNickColor);
	public Button buyAntiAFK = new Button(Message.buyAntiAFK);
	...
	{			
		...
		buyBronze.addActionListener(this);
		buySilver.addActionListener(this);
		buyGold.addActionListener(this);
		buyDiamond.addActionListener(this);
                buyGod.addActionListener(this);
                buyFly.addActionListener(this);
                buyPrefix.addActionListener(this);
                buyNickColor.addActionListener(this);
                buyAntiAFK.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource() == buyBronze){
			openURL(Settings.buyBronzeLink);
		}

		if(e.getSource() == buySilver){
			openURL(Settings.buySilverLink);
		}
		
		if(e.getSource() == buyGold){
			openURL(Settings.buyGoldLink);
		}
		
		if(e.getSource() == buyDiamond){
			openURL(Settings.buyDiamondLink);
		}
		
                if(e.getSource() == buyGod){
			openURL(Settings.buyGodLink);
		}
                if(e.getSource() == buyFly){
			openURL(Settings.buyFlyLink);
		}
                if(e.getSource() == buyPrefix){
			openURL(Settings.buyPrefixLink);
		}
                if(e.getSource() == buyNickColor){
			openURL(Settings.buyNickColorLink);
		}
                if(e.getSource() == buyAntiAFK){
			openURL(Settings.buyAntiAFKLink);
		}
	...
	public void setPersonal(PersonalContainer pc)
	{
		...
		if(pc.canUploadSkin) 
		{
			...
			panel.add(buySilver);
			panel.add(buyGold);
			panel.add(buyDiamond);
			panel.add(buyGod);
			panel.add(buyFly);
			panel.add(buyPrefix);
			panel.add(buyNickColor);
			panel.add(buyAntiAFK);
		}
